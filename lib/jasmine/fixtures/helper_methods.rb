...
RSpec::Rails::ControllerExampleGroup.extend(Jasmine::Fixtures::HelperMethods) if defined?(RSpec::Rails::ControllerExampleGroup)
ActionController::TestCase.send(:include, Jasmine::Fixtures::HelperMethods) if defined?(ActionController::TestCase)

include Jasmine::Fixtures::HelperMethods